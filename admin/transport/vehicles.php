            ...
            if ($query == "add") {
                echo "
					<div class='card account custom-shadow mt-4 p-3'>
						<h3 class='text-center' style='background-color:gray;color:white;border-radius: 1rem 0 0 1rem;'>Add Vehicle🚙</h3>
						<hr>
						<form class='card-body' style='background-color:gray;color:white;' method='POST' action='./manage-vehicle.php'>
							...
							<div class='text-center'>
								<button type='submit' name='add_vehicle' class='btn btn-outline-dark w-50'>ADD</button>
							</div>
						</form>
					</div>
				";
